...
@section('title', 'Buat Text Kontak')
              ...
              <div class="col-12">
                <div class="card">
                  <div class="section-header">
                    <h4>Buat Text Kontak</h4>
                    <div class="section-header-button ml-auto">
                     <a href="{{ route('text_kontak.index')}}" class="btn btn-primary ">
                        <i class="fas fa-arrow-left"></i> Kembali</a>
                  </div>
                  </div>
                  <form action="{{ route('text_kontak.store') }}" method="post">
                      @csrf
                    <div class="card-body">
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="text" name="desk" class="form-control" id="text" >
                      </div>
                    </div>
