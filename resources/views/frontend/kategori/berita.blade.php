...
@section('content')
      <section class="berita pt-100">
        <h2 class="text-center justify-content-center">Berita seputar jurusan smk bakti nusantara 666 </h2>
              ...
              <div class="col-12 col-md-6 col-lg-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p>
                            <small>
                                By.<a href="/authors/{{ $row->users->id }}">{{ $row->users->name}}</a> {{ $row->created_at->diffForHumans() }}
                             </small>
                        </p>
